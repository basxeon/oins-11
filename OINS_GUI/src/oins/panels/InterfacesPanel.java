...
public class InterfacesPanel extends GenericPanel {
	...
	public InterfacesPanel(){
		...
		// Ponizej jest ladowanie danych do tabeli - zrobilem przyklad jak to sie robi z pliku 
		// konfiguracyjnego u Ciebie powinno byc analogicznie. Pamietaj ze insertNewDate dostaje tablice
		// Object[][]
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals(BUT1)){
			int response =  JOptionPane.showConfirmDialog(this, "Wybra³eœ interfejs: " +
					InterfacesTable.getChoosenInterface() + ". \n Czy chcesz kontynuowaæ?", "Question",JOptionPane.YES_NO_OPTION);
